...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Nucleo_NRST_Pin USR_BTN_2_Pin USR_BTN_3_Pin Soft_NRST_Pin */
  GPIO_InitStruct.Pin = Nucleo_NRST_Pin|USR_BTN_2_Pin|USR_BTN_3_Pin|Soft_NRST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : pwr_Enable_Pin */
  ...
  /*Configure GPIO pins : USR_LED_2_Pin USR_LED_3_Pin USR_LED_4_Pin */
